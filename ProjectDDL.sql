...
SELECT CareCenter.careCenterName, COUNT(bedNumber) AS 'totalBeds' FROM CareCenter
INNER JOIN Bed ON CareCenter.careCenterName = Bed.careCenterName
GROUP BY CareCenter.careCenterName;

CREATE VIEW EmptyBeds AS
SELECT CareCenter.careCenterName, COUNT(bedNumber) AS 'emptyBeds' FROM CareCenter
INNER JOIN Bed ON CareCenter.careCenterName = Bed.careCenterName
WHERE patientID IS NULL
GROUP BY CareCenter.careCenterName;

CREATE VIEW OccupiedBeds AS
SELECT CareCenter.careCenterName, COUNT(bedNumber) AS 'occupiedBeds' FROM CareCenter
INNER JOIN Bed ON CareCenter.careCenterName = Bed.careCenterName
